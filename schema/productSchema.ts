...
export const productFormSchema = z.object({
  ...
  productPrice: z.string({ required_error: "Product price is required.", }).min(1, { message: "Product name is required.", })
    .refine(
      (value) => {
  ...
  productQuantity: z.string().min(1, { message: "Product quantity is required." }).refine((value) => value !== "0", {
