...
export default function Home() {
  return (
    <>
      ...
      {/* Feature section */}
      <div className="mx-auto pb-24 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">Engage Leads Effortlessly</h2>
            <p className="mt-4 text-lg text-gray-600">Elevate your campaigns with adscrush&apos;s seamless lead management, designed for intuitive and efficient control of your marketing journey..</p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="text-xl font-semibold">Upload your products</span>
              <span className="mt-2 text-zinc-700">Efficiently process your data for seamless and effective interaction.</span>
            </div>
          </li>
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-medium text-blue-600">Step 3</span>
              <span className="text-xl font-semibold">Start creating campaign</span>
              <span className="mt-2 text-zinc-700">It&apos;s that simple. Try out adscrush today - it really takes less than a minute.</span>
            </div>
          </li>
        </ol>

        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="mt-16 flow-root sm:mt-24 mb-16">
            <div className="m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
              <Image
                src={fileUploadPreview.src}
                alt="uploading preview"
                width={1419}
                height={732}
                quality={100}
                blurDataURL={fileUploadPreview.blurDataURL}
