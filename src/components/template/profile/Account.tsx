      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} >
          <div className="form-container vertical">
            ...
            {/* submit reset button */}
            {!isEditing ?
              <div className="py-8 flex justify-end gap-2 border-gray-200">
                <div className="mt-4 ltr:text-right">
                  <Button
                    className="button bg-white border border-gray-300 dark:bg-gray-700 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 active:bg-gray-100 dark:active:bg-gray-500 dark:active:border-gray-500 text-gray-600 dark:text-gray-100 radius-round h-11 px-8 py-2 mr-2"
                    type="button"
                    onClick={() => form.reset()}
                  >
                    Reset
                        ...
                        render={({ field }) => (<FormItem>
                          ...
                          {user?.apiKeys.some((apiKey) => apiKey.enabled === true) || (newApiKey && newApiKey.enabled === true) ? (
                            <CopyButton
                              ...
                              aria-label='API Key'
                              disabled={isGeneratingApi}
                              className={cn('absolute inset-y-0 right-0 animate-in fade-in duration-300 !my-0 bg-gray-200/60 h-9')}
