...
interface CompanyBusinessLocationProps {
...
const CompanyBusinessLocation: FC<CompanyBusinessLocationProps> = ({ data, companyId }) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2">
                  ...
                  <FormControl>
                    <Input type="text" size="sm" variant="faded" placeholder="Landmark" defaultValue={field.value} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
